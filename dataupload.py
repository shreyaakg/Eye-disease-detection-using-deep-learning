...
class ViewData:
    def __init__(self):
        def dataupload():
            s1 = "C:\EYE DISEASE\Dataset"
            messagebox.showinfo("Success", s1)

        def viewdata():
            workingDir = "D:/EYE DISEASE/Dataset/train"
            ...
            train_dir5 = os.path.join(train_dir, "Uveitis")
            ...
            val_dir5 = os.path.join(validation_dir, "Uveitis")
            ...
            total_train = train_images1 + train_images2+train_images3+train_images4+train_images5
            total_val = images_val1 + images_val2+images_val3+images_val4+images_val5
